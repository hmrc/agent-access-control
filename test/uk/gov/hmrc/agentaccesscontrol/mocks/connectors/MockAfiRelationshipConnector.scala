...
trait MockAfiRelationshipConnector extends MockFactory {

  protected val mockAfiRelationshipConnector: AfiRelationshipConnector =
    mock[AfiRelationshipConnector]

  def mockHasRelationship(
      arn: String,
      clientId: String,
      result: Future[Boolean]): CallHandler4[String,
                                             String,
                                             HeaderCarrier,
                                             ExecutionContext,
                                             Future[Boolean]] = {
    (mockAfiRelationshipConnector
      .hasRelationship(_: String, _: String)(_: HeaderCarrier,
                                             _: ExecutionContext))
